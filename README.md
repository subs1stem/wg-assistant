...
* And, of course, **you should already have WireGuard deployed on your server**. It's recommended to add names to peers
  for convenience, as shown in the example, if you are using the default
  **WireGuard**:
